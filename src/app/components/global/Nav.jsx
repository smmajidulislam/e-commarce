    ...
    <nav className="bg-gray-800 text-white sticky top-0 z-999 tracking-wide">
      <div className="max-w-7xl mx-auto px-2 sm:px-4 lg:px-6">
        <div className="flex items-center justify-around h-16">
          ...
          <div className="hidden md:flex space-x-4 text-xl">
            ...
            <Link href="/cart" className="hover:bg-gray-700 px-3 py-2 rounded">
              WishList
            </Link>
      ...
      {isMobileMenuOpen && (
        <div className="md:hidden bg-gray-800">
          ...
          <Link href="/service" className="hover:bg-gray-700 px-3 py-2 rounded">
            Service
          </Link>
          <Link href="/login" className="hover:bg-gray-700 px-3 py-2 rounded">
            Login
          </Link>
          <Link href="/singup" className="hover:bg-gray-700 px-3 py-2 rounded">
            Singup
          </Link>
          <Link href="/about" className="hover:bg-gray-700 px-3 py-2 rounded">
            About
